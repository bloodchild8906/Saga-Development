...
namespace TcgEngine.UI
{
    ...
    public class CollectionPanel : UIPanel
    {
        ...
        private void RefreshDeckCards()
        {
            ...
            deck_quantity.text = count + "/" + GameplayData.Get().deckSize;
            deck_quantity.color = count >= GameplayData.Get().deckSize ? Color.white : Color.red;
        ...
        public void OnClickCard(CardUI card)
        {
            ...
            if (icard != null)
            {
                ...
                bool deck_limit = in_deck_same < GameplayData.Get().deckDuplicateMax;
