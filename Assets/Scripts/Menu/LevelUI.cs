    ...
    public class LevelUI : MonoBehaviour
    {
        ...
        public void OnClick()
        {
            if (level != null)
            {
                ...
                GameClient.player_settings.deck = new UserDeckData(level.playerDeck);
                GameClient.ai_settings.deck = new UserDeckData(level.aiDeck);
                GameClient.ai_settings.ai_level = level.aiLevel;
