    ...
    public class DeckDisplay : MonoBehaviour
    {
        ...
        public void SetDeck(UserDeckData deck)
        {
            ...
            if (deck != null)
            {
                ...
                if (card_count != null)
                {
                    card_count.text = deck.GetQuantity().ToString() + " / " + GameplayData.Get().deckSize.ToString();
                    card_count.color = deck.GetQuantity() >= GameplayData.Get().deckSize ? Color.white : Color.red;
                }
